 ...
 * This version removes demo terminology from the description and tagline.
 */
...
export default function Profile() {
  ...
  /**
   * Sign out by removing the saved userEmail from localStorage and reloading
   * the page. This will redirect the user back to the login screen defined in
   * App.tsx. We do not clear the game state here so that if the user signs
   * back in with the same email, their progress is preserved.
   */
  function handleSignOut() {
    ...
    // Force a reload to ensure the App component re-evaluates isLoggedIn
    ...
    <div className="min-h-screen pb-safe">
      <div className="container py-6 space-y-4">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          {/* Remove the Hunter-specific tagline */}
          <p className="text-xs text-gray-500 font-mono mt-1">User profile and settings.</p>
        </motion.div>
        ...
        <div className="flex justify-center pb-6">
          <button
            ...
            className="px-4 py-2 bg-white/[0.05] border border-white/[0.1] rounded-sm text-xs text-gray-400 font-mono hover:bg-white/[0.08] transition-colors"
          >
            Sign Out
          </button>
        </div>
