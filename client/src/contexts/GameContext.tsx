...
/**
 * GameContext provides the core state management for the Leveling game. It keeps
 * track of the user, quests, logs and system messages. To remove any demo
 * presets the default user now has an empty name and the initial system log
 * starts empty. All other logic remains identical to the original game engine.
 */
...
function createDefaultUser(): User {
  return {
    id: generateId(),
    // Do not preset the name; this will be set via the login page
    name: '',
    level: 1,
    totalXP: 0,
    currentXP: 0,
...
function createDefaultState(): GameState {
  return {
    ...
    logs: [],
    quests: [],
    // Start with an empty system log; the login and game actions will populate it
    systemLog: [],
  };
}
